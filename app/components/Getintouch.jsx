...
import whatsappanimation from '../js/whatsappanimation.js';
...
const Getintouch = () => {
  ...
  /* accordian start */
  useEffect(() => {
    const accordionHeaderss = document.querySelectorAll('.accordion-header');
          ...
          <div className="gradient-purple" id="onzefriendescriptiononzefriet">
            ...
            <div className="gradient-threebox gradient-threeboxgetintouch">
              ...
              >
                ...
                >
                  <video controls preload="true" src="https://cdn.shopify.com/videos/c/o/v/6a8710d0b59e43c1bb1d565f2985b813.mp4" loop muted playsInline/>
                  {/* <iframe
                    title="tiktok"
                ...
                >
                  <video controls preload="true" src="https://cdn.shopify.com/videos/c/o/v/69ee51f392084784994b1ca6b5ef227a.mp4" loop muted playsInline />
                  {/* <iframe
                    title="tiktok"
                ...
                >
                  <video controls preload="true" src="https://cdn.shopify.com/videos/c/o/v/6b07ae8f50764096a2c77ec414f5442f.mp4" loop muted playsInline />
                  {/* <iframe
                    title="tiktok"
