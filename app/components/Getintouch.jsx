                ...
                <div className="gradient-purple" id="onzefriendescriptiononzefriet">
                    ...
                    <div className="whitebgbox">
                        ...
                        <div className='socialiconlist'>
                            <ul>
                                {Object.entries(contentSection.socialMedia[0]).map(([key, value]) => {
                                    if (key !== '_key' && key !== 'title') {
                                        return (
                                            <li>
                                            <a key={key} href={value} target="_blank" rel="noopener noreferrer" style={{ margin: '0 10px', display: 'inline-flex', alignItems: 'center' }}>
                                                <img
                                                    src={iconMap[key]}
                                                    alt={key}
