      ...
      <div className="newcontainer">
        ...
        <div className="allmenulist">
          ...
          <div className="footerblock">
            ...
            {socials.facebook && <li><a href={socials.facebook}><svg
          ...
          {socials.insta && <li><a href={socials.insta}><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="31"
                    height="32"
                    viewBox="0 0 31 32"
          ...
          {socials.linkedIn && <li><a href={socials.linkedIn}><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="31"
                    height="32"
                    viewBox="0 0 31 32"
          ...
          {socials.tiktok && <li><a href={socials.tiktok}><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="21"
                    height="26"
                    viewBox="0 0 21 26"
