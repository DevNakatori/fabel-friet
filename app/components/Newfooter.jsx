          ...
          <div className="footerblock">
            ...
            <div className="footerlistbox">
              <ul>
                {menu.map((item) => (
                  <li key={item._key}>
                    <a href={item.link} aria-label={item.label} onClick={(event) => handleMenuItemClicks(event, item.link)}>
                      {item.label}
                    </a>
                  </li>
                ))}
            ...
            {socials.facebook && (
                <li>
                  <a aria-label="socials">
                    <svg fill="#EFEBE7" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
