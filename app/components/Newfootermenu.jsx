        ...
        <div className="allmenulist">
            <div className="footerblock">
                ...
                <div className="footerlistbox">
                    <ul>
                        <li><a href="/">Home</a></li>
                        <li><a href="/#section2">Onze Friet</a></li>
                        <li><a href="/#section3">Locaties</a></li>
                        <li><a href="/#section4">Menu</a></li>
                        <li><a href="/#section5">Fabel Impact</a></li>
                        <li><a href="/#section6">Contact</a></li>
                        <li><a href="/pages/franchise" aria-label="Franchise">Franchise</a></li>
                    </ul>
                </div>
            </div>
            <div className="footerblock">
                ...
                <div className="footerlistbox">
                    <ul>
                        <li><a href="tel:0203031422">0203031422</a></li>
                        <li><a href="mailto:info@fabelfriet.nl">info@fabelfriet.nl</a></li>
                    </ul>
                    <ul>
            ...
            <div className="footerblock">
                ...
                <ul className="footersociallist">
                    <li>
                    <a href="www.whatsup.com">
                        <svg fill="#EFEBE7" height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 308 308" xmlSpace="preserve"><g id="XMLID_468_"><path id="XMLID_469_" d="M227.904,176.981c-0.6-0.288-23.054-11.345-27.044-12.781c-1.629-0.585-3.374-1.156-5.23-1.156
